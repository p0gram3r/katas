...
public class PatternValidatorTest {
    ...
    public static Collection<Object[]> data() {
        ...
        return Arrays.asList(new Object[][] { 
                ...
                {pattern(RED, YELLOW), pattern(YELLOW, BLUE), pattern(WHITE)},
                {pattern(RED, YELLOW), pattern(BLUE, RED), pattern(WHITE)},
                {pattern(RED, YELLOW), pattern(YELLOW, RED), pattern(WHITE, WHITE)},
                {pattern(RED, YELLOW), pattern(RED, BLUE), pattern(BLACK)},
                {pattern(RED, YELLOW), pattern(BLUE, YELLOW), pattern(BLACK)},
                {pattern(RED, YELLOW), pattern(RED, YELLOW), pattern(BLACK, BLACK)},
                
                // 3 unique colors
                {pattern(RED, YELLOW, GREEN), pattern(BLUE, BLUE, BLUE), pattern()},
                {pattern(RED, YELLOW, GREEN), pattern(YELLOW, BLUE, BLUE), pattern(WHITE)},
                {pattern(RED, YELLOW, GREEN), pattern(YELLOW, GREEN, BLUE), pattern(WHITE, WHITE)},
                {pattern(RED, YELLOW, GREEN), pattern(YELLOW, GREEN, RED), pattern(WHITE, WHITE, WHITE)},
                {pattern(RED, YELLOW, GREEN), pattern(RED, YELLOW, BLUE), pattern(BLACK, BLACK)},
